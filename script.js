...
cuadrado2.addEventListener('mouseover', ()=>{
    cuadrado2.style.background = "yellow";
});
...
cuadrado3.addEventListener('mouseover', ()=>{
    cuadrado3.style.background = "yellow";
});
...
cuadrado4.addEventListener('mouseover', ()=>{
    cuadrado4.style.background = "yellow";
});
...
cuadrado5.addEventListener('mouseover', ()=>{
    cuadrado5.style.background = "yellow";
});
...
cuadrado6.addEventListener('mouseover', ()=>{
    cuadrado6.style.background = "yellow";
});
...
cuadrado7.addEventListener('mouseover', ()=>{
    cuadrado7.style.background = "yellow";
});
...
cuadrado8.addEventListener('mouseover', ()=>{
    cuadrado8.style.background = "yellow";
});
...
cuadrado9.addEventListener('mouseover', ()=>{
    cuadrado9.style.background = "yellow";
});
...
cuadrado10.addEventListener('mouseover', ()=>{
    cuadrado10.style.background = "yellow";
});
...
cuadrado11.addEventListener('mouseover', ()=>{
    cuadrado11.style.background = "yellow";
});
...
cuadrado12.addEventListener('mouseover', ()=>{
    cuadrado12.style.background = "yellow";
});
...
cuadrado13.addEventListener('mouseover', ()=>{
    cuadrado13.style.background = "yellow";
});
...
cuadrado14.addEventListener('mouseover', ()=>{
    cuadrado14.style.background = "yellow";
});
...
cuadrado15.addEventListener('mouseover', ()=>{
...
cuadrado16.addEventListener('mouseover', ()=>{
